...
import { addWaitlist, clearWaitlist } from '../../../store/actions/waitlist_actions';
...
const AddWaitlist = () => {
    ...
    return (
        <div className="patient-input-container">
            <div>
                <h4>Add Patient to WaitList Here:</h4>
